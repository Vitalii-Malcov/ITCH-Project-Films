...
# __file__ → .../itch_films/services/ai_posters/poster_repository.py
# dirname × 3 → itch_films/ (корень ЭТОГО проекта, не репозитория —
# services/ai_posters/ живёт внутри itch_films/, а не на уровне
