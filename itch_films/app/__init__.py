...
# лежит в itch_films/services/firecrawl/ (используется только
# для блока «Подробнее» в film_news.py, это не отдельный сервис).
# ─────────────────────────────────────────────

import os
import sys

# Корень itch_films/ — на один уровень выше этого файла (app/ → itch_films/).
# Вставляем его в sys.path[0] ПЕРВЫМ ДЕЛОМ, до любых других импортов —
# в репозитории рядом лежат ещё два независимых проекта (itch_films_2,
# itch_films_OOP), и у всех троих есть свои local_settings.py и свой
...
# .env из itch_films/ — там лежат ключи OpenAI и Firecrawl.
